...
public class consumer {
    public static void main(String[] args) {
        ...
        // 从注册中心获取服务的 URL
        myURL serviceUrl = getServiceURLFromRegistry(registryIp, registryPort, serviceClassName);
    ...
    private static myURL getServiceURLFromRegistry(String registryIp, int registryPort, String interfaceClass) {
        try {
            // 构建注册中心的URL
            ...
            // 设置请求体
            String payload = "{\"interfaceClassName\": \"" + interfaceClass + "\"}";
    ...
    private static void printHelp() {
        System.out.println("Usage: consumer -i <registryIp> -p <registryPort>");
